...
equation
  ...
  connect(Q_flowSum.y, heaFloToSou.Q_flow)
    annotation (Line(points={{72,70},{80,70},{80,36.2}},
                                                       color={0,0,127}));
  ...
  connect(heaFloEff.Q_flow, heaFloSenToLoa.Q_flow)
    annotation (Line(points={{11,176},{14,176},{14,240},{47.8,240}},
                                                                   color={0,0,127}));
  ...
  if cooMod then
    ...
    connect(addPar.y, div.u2) annotation (Line(points={{-18,70},{-12,70},{-12,
